...
export class InjuriesController {
  ...
  @ApiOperation({
    ...
    description:
      "Report a new injury for a player. Players can report their own injuries, coaches and admins can report for any player.",
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiResponse({
    status: 403,
    description:
      "Forbidden - insufficient permissions (requires coach or admin role)",
  })
  async create(
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve a paginated list of injuries. Players see only their own injuries. Coaches and admins can see all injuries with optional filters.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve detailed information about a specific injury including status updates. Players can only view their own injuries.",
  })
  @ApiParam({
    name: "id",
  ...
  async findOne(
    ...
    try {
      ...
      if (
        req.user.identityType === "player" &&
        injury.player?.pseudonymId !== req.user.pseudonym
      ) {
  ...
  @ApiOperation({
    ...
    description:
      "Update injury status, treatment plan, or other details. Only coaches and admins can update injuries.",
  })
  @ApiParam({
    name: "id",
    description: "Injury ID (e.g., INJ-2024-001)",
  ...
  async update(
    ...
    try {
      ...
      return await this.injuriesService.updateInjury(
        id,
        updateInjuryDto,
        updatedBy,
      );
  ...
  @ApiOperation({
    ...
    description:
      "Complete the injury lifecycle by marking it as recovered with return-to-play date. Only coaches and admins can resolve injuries.",
  })
  @ApiParam({
    name: "id",
    description: "Injury ID (e.g., INJ-2024-001)",
  ...
  async resolve(
    ...
    try {
      ...
      return await this.injuriesService.resolveInjury(
        id,
        resolveDto,
        resolvedBy,
      );
