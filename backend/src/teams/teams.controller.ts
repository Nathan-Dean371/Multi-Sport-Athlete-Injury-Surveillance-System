...
export class TeamsController {
  ...
  @Roles("admin")
  async createTeamForAdmin(
    @Body() dto: CreateTeamAdminDto,
  ): Promise<TeamDetailsDto> {
    return this.teamsService.createTeamForAdmin(dto);
  }

  @Get("admin/coach/:coachPseudonymId")
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles("admin")
  async getCoachTeamsForAdmin(
    @Param("coachPseudonymId") coachPseudonymId: string,
  ): Promise<TeamDetailsDto[]> {
    return this.teamsService.getCoachTeamsForAdmin(coachPseudonymId);
  }
  ...
  @ApiOperation({
    ...
    description:
      "Returns all teams that the authenticated coach manages. Only accessible by coaches.",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      "Returns all players on the team with their latest status updates and active injury counts. Only accessible by coaches who manage this team.",
  })
  @ApiParam({
    name: "teamId",
  ...
  @ApiOperation({
    ...
    description:
      "Returns team information including coaches and player count. Accessible to authenticated users who belong to the team.",
  })
  @ApiParam({
    name: "teamId",
    description: "Team unique identifier",
