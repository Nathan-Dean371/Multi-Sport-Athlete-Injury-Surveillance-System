...
type AcceptAthleteInvitationRequest = {
  token: string;
  dateOfBirth: string;
  password: string;
};

function AthleteAcceptContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: AcceptAthleteInvitationRequest = {
        token,
        dateOfBirth,
        password,
      };

      const response = await fetch(`${API_URL}/players/accept-invite`, {
        method: "POST",
        headers: {
      ...
      console.error("Failed to accept athlete invitation:", err);
              ...
              <div className="bg-gray-700/50 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300">Role: Athlete</span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gray-800 rounded-xl shadow-xl border border-gray-700 overflow-hidden">
            ...
            <div className="p-8">
              <p className="text-gray-300 mb-6">
                The Injury Surveillance mobile app is where you’ll update your
                status and track injuries.
              </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-6">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Complete your athlete account setup</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1">
                Used to verify the athlete profile
              </p>
            </div>
...
export default function AcceptAthleteInvitationPage() {
  return (
    <Suspense
      fallback={
