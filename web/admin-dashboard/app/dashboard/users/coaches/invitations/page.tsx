...
import type { PendingCoachInvitation } from "@/lib/api";
...
export default function CoachInvitationsPage() {
  ...
  const fetchInvitations = async () => {
    try {
      setLoading(true);
      setError(null);
      const data = await apiClient.getPendingCoachInvitations();
        ...
        <div className="bg-gray-800 rounded-xl shadow-xl border border-gray-700 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-5">
            ...
            <p className="text-blue-100 mt-1">
              Manage invitations sent to coaches who haven't joined yet
            </p>
          </div>
