...
.\start-demo.ps1
```
This will open three terminals for the Docker stack, the mobile app, and the admin dashboard.

### Option 2: Manual Start
```powershell
# Terminal 1 - Docker stack (databases + backend)
...
# Terminal 3 - Admin dashboard (in \web\admin-dashboard folder)
