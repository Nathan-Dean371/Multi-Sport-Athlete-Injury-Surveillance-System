...
- **What:** Dynamic reporting dashboard for analyzing injury data across the system
- **Where:** Admin Dashboard → Report Builder (`/dashboard/reports`)
- **Key Features:** 15+ metrics, flexible filtering, real-time generation, CSV/JSON export
- **Quick Start:** Select filters → Choose metrics → Click "Generate Report" → Export if needed
- **Full Details:** See [Features & Capabilities](#features--capabilities) section below
...
- [Coach Injury Reporting Feature](COACH-INJURY-REPORTING.md)
